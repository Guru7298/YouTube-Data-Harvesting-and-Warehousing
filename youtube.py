...
#API key connection
def Api_connect():
    Api_Id="AIzaSyBiItzc74bYlhOxefsmxIVtGPuWznOH15g"
    ...
    for video_id in video_ids:
        ...
        for item in response["items"]:
            data=dict(Channel_Name=item['snippet']['channelTitle'],
                    ...
                    Cption_Status=item['contentDetails']['caption']
                    )
...
def channel_details(channel_id):
    ...
    coll1.insert_one({"channel_information":ch_details,"plalist_information":pl_details,
                       "video_information":vi_details,"comment_information":com_details})
    
    return "upload completes successfully"
...
def playlists_table():
    ...
    try:
        ...
        st.writet("Playlists Table alredy created")    
